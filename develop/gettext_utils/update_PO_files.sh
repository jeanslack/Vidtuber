...
# Rev: July.10.2024
#
# PORPOSE: Updates all translation strings of vidtuber.po files
#          located in "vidtuber/data/locale" .
#
...
POT="$TARGET/vidtuber.pot"  # pot file
...
do
    PO="${langdirs}LC_MESSAGES/vidtuber.po"
    ...
    \cp -rf temp.po $PO
    \rm test.po
    echo "Update '${langdirs}LC_MESSAGES/vidtuber.po' ...OK"
done
