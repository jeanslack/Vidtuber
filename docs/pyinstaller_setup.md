-----------------
# Make Vidtuber bundle with pyinstaller on macOS
...
by Vidtuber. Now, you can copy and paste all the `bin` folder to
`/Vidtuber3/MAcOsxSetup/FFMPEG_BIN/`, or you can set the path later on Vidtuber.
...
To build a Vidtuber.app I suggest you create a virtual environment, Exhaustive
...
- Download the [Vidtuber](https://github.com/jeanslack/Vidtuber) TAR or ZIP
sources and extract the archive.

- Make sure you have installed pyinstaller `python3 -m pip install --user pyinstaller`

- Open root directory of the Vidtuber sources that you just extracted
from the archive  e.g. `$ cd Vidtuber`
