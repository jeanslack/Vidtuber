...
# Porpose: Contains test cases for the Vidtuber object.
...
class GuiTestCase(unittest.TestCase):
    """
    Test case for Vidtuber GUI. It tests the bootstrap of
    the wxPython module by starting Vidtuber app.
    """

    def setUp(self):
        """Method called to prepare the test fixture"""
        kwargs = {'make_portable': None}
        self.app = gui_app.Vidtuber(redirect=False, **kwargs)
